   ...
   Robot wheel mapping:
      ...
      X  BL       BR  X
        X           X
          X       X
*/
@TeleOp(name = "Full Tele Op 1.2", group = "Tele Op")
public class full_teleop extends OpMode {
    ...
    public void loop() {
        ...
        motorFrontRight.setPower(FrontRight/1.5);
        motorFrontLeft.setPower(FrontLeft/1.5);
        motorBackLeft.setPower(-BackLeft/1.5);
        motorBackRight.setPower(-BackRight/1.5);

        lift.setPower(-gamepad2LeftY/1.5);
